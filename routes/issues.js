...
var path = require('path');
     ...
     * Postcondition:
     *s An array of objects such that each object contains the following:
     ...
     * assignee (string) : The uername of the person who was assigned the issue
     */
    router.get('/issues_req', function(req,res){
        res.sendFile(path.join(__dirname, '../', 'public', 'partials', 'issues.partial.html'));
    });
    ...
    router.get('/issues', function(req, res) {
        ...
        var getData = function(pageCounter) {
            request({
                ...
                headers: { 'user-agent': 'git_technetium' },
                json: true
